 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `SSDKHBModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface SSDKAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation SSDKAuthor
     @end
 
     @interface SSDKBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) SSDKAuthor *author;
     @end
     @implementation SSDKBook
     @end
    
     int main() {
         // create model from json
         SSDKBook *book = [SSDKBook ssdk_hb_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book ssdk_hb_modelToJSONString];
 ...
 @code
     @interface SSDKShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation SSDKShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self ssdk_hb_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self ssdk_hb_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self ssdk_hb_modelCopy]; }
     - (NSUInteger)hash { return [self ssdk_hb_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self ssdk_hb_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (SSDKHBModel)
 ...
 */
+ (nullable instancetype)ssdk_hb_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)ssdk_hb_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)ssdk_hb_modelToJSONObject;
 ...
 */
- (nullable NSData *)ssdk_hb_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)ssdk_hb_modelToJSONString;
 ...
 */
+ (nullable NSArray *)ssdk_hb_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (SSDKHBModel)
 ...
 */
+ (nullable NSDictionary *)ssdk_hb_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<SSDKHBModel>' to your class header.
 */
@protocol SSDKHBModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class SSDKShadow, SSDKBorder, SSDKAttachment;
 
        @interface SSDKAttributes
        @property NSString *name;
        ...
        @implementation SSDKAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [SSDKShadow class],
                     @"borders" : SSDKBorder.class,
                     @"attachments" : @"SSDKAttachment" };
        }
        @end
  @endcode
...
/**
 ...
 Example:
 @code
        @class SSDKCircle, SSDKRectangle, SSDKLine;
 
        @implementation SSDKShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [SSDKCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [SSDKRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [SSDKLine class];
            } else {
                return [self class];
            }
        }
